...
| Constitution Principle Violated | Why Needed | Simpler Alternative Rejected Because |
|--------------------------------|------------|-------------------------------------|
| [e.g., SRP - combined module] | [current need] | [why separation insufficient] |
| [e.g., DRY - duplication] | [specific problem] | [why abstraction insufficient] |
| [e.g., Production-First - no monitoring] | [timeline constraint] | [why can't add monitoring] |
