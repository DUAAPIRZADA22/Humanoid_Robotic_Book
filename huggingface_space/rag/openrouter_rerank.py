"""
OpenRouter-based reranking service using semantic similarity.
Provides document reranking using OpenRouter embeddings and similarity calculations.
"""
...
from .openrouter_embeddings import OpenRouterEmbeddingService
...
class OpenRouterReranker:
    """
    OpenRouter-based reranking service using embedding similarity.
    """
    ...
    def __init__(
        ...
        self.embedding_service = OpenRouterEmbeddingService(
            api_key=api_key,
            model=model,
            timeout=timeout,
            base_url=base_url
        ...
        logger.info(f"Initialized OpenRouter reranker with model: {model}")
    ...
    async def rerank(
        ...
        """
        Rerank documents based on relevance to query using OpenRouter embeddings.
...
def create_openrouter_reranker(config: Optional[Dict[str, Any]] = None) -> OpenRouterReranker:
    """
    Create an OpenRouter reranker with the given configuration.

    Args:
        config: Configuration dictionary

    Returns:
        OpenRouterReranker instance
    """
    if config is None:
        config = {}
